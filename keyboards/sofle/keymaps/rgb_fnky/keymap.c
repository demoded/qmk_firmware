  ...
  */
// SOFLE RGB FNKY STD Layout http://www.keyboard-layout-editor.com/#/gists/eec8627261ab1270f3f8f86f4e763f8b
#include <stdio.h>
...
[_RAISE] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  KC_GRV,    KC_NO,  KC_NO,   KC_NO,   KC_NO,  KC_NO,                     _______, KC_HOME, KC_UP,   KC_END,  KC_NO,   KC_F12,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_NO,   KC_NO,   KC_WH_U, KC_PGUP,                   _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_DEL,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_NO,   KC_NO,   KC_WH_D, KC_PGDN,_______,    _______,SGUI(KC_RGHT),  KC_NO,   KC_NO,   KC_NO,   KC_NO,    _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
